...
import 'package:learnup/core/phone_field/intl_phone_field.dart';
...
class PrimaryColors {
  ...
  Color get bgColor => PrefUtils().getThemeData() == "primary"
      ? Color(0XFFFFFFFF)
      : Color(0XFF1D1D1D);
  Color get viewAllButtonColor => PrefUtils().getThemeData() == "primary"
      ? Color(0XFF030401)
      : Color(0XFFFFFFFF);
  Color get containerbgColor =>
      PrefUtils().getThemeData() == "primary" ? lightGray : darkInput;
  Color get iconButtonbgColor => PrefUtils().getThemeData() == "primary"
      ? Color(0XFFFFFFFF)
      : Color(0XFF1E1E1E);
  Color get progressBarColor => PrefUtils().getThemeData() == "primary"
      ? Color(0XFFEDEDED)
      : Color(0XFF2B2B2B);
  Color get gray =>
      PrefUtils().getThemeData() == "primary" ? Color(0XFFF5F5F5) : darkInput;
}
...
Widget phone_number_field(controller, String? Function(String?)? validator) {
  return IntlPhoneField(
    ...
    flagsButtonMargin: EdgeInsets.only(left: 16.h, right: 14.h),
    style: TextStyle(
      color: appTheme.black900,
      fontSize: 16.fSize,
      fontFamily: 'SF Pro Display',
