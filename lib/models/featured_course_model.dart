  ...
  static List<FavoritegridItemModel> getFeaturedCource() {
    return [
      FavoritegridItemModel(
          ...
          false),
      FavoritegridItemModel(
          ImageConstant.imgGroupIndianCh3,
          ...
          false),
      FavoritegridItemModel(
          ImageConstant.imgGroupIndianCh1,
          ...
          false),
      FavoritegridItemModel(
          ImageConstant.imgGroupIndianCh4,
          "Learn faster and more effectively with elearning",
          ImageConstant.imgUser4,
          "Ralph edwards",
          "Cordinator",
          "\$75.00",
          false),
      FavoritegridItemModel(
          ImageConstant.imgGroupIndianCh5,
          ...
          false),
      FavoritegridItemModel(
          ImageConstant.imgGroupIndianCh115x174,
          "How elearning can help you achieve your goals",
          ImageConstant.imgUser6,
          "Guy hawkins",
          "Cordinator",
          "\$42.00",
          false),
      FavoritegridItemModel(
          ImageConstant.imgGroupIndianCh6,
          ...
          false),
      FavoritegridItemModel(
          ImageConstant.imgGroupIndianCh7,
          "Learn new skills, advance your career",
          ImageConstant.imgUser2,
          "Ralph Edwards",
          "Cordinator",
